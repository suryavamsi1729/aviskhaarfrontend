  ...
  return (
    <div className="w-full h-screen flex items-center justify-center bg-white">
      <div className="flex flex-col items-center max-w-sm mx-auto text-center">
        <p className="p-3 text-sm font-medium text-red-600 rounded-full bg-red-100">
          <svg
        ...
        <div className="flex items-center w-full mt-6 gap-x-3 shrink-0 sm:w-auto">
          ...
          <button
            ...
            className="w-1/2 px-5 py-2 text-sm tracking-wide text-white transition-colors duration-200 bg-slate-950 rounded-lg shrink-0 sm:w-auto hover:bg-slate-900"
          >
            Take me home
          </button>
        </div>
